...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("xuxucli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("XUXUCLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".xuxucli", "runtime").toString();
        }
