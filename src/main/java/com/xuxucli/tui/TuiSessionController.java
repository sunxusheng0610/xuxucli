...
import com.xuxucli.tui.history.ConversationSnapshot;
import com.xuxucli.tui.pane.CenterPane;
import com.xuxucli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final XuxuCliConfig config;
    ...
    public TuiSessionController(XuxuCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "xuxucli-tui-agent-runner");
