...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(XuxuCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("xuxucli v16.0.0");
    ...
    public XuxuCliConfig getConfig() {
        return config;
    }
}
