package com.xuxucli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[xuxucli] stdout reader stopped: " + e.getMessage());
            }
        }, "xuxucli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[xuxucli] stderr reader stopped: " + e.getMessage());
            }
        }, "xuxucli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
