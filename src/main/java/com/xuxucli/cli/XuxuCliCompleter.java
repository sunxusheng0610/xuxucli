...
import com.xuxucli.mcp.mention.AtMentionCompleter;
...
final class XuxuCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    XuxuCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
