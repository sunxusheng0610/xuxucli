...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("xuxucli.memory.dir");
        System.setProperty("xuxucli.memory.dir", tempDir.toString());
        try {
            ...
            agent.run("打开 https://www.yuque.com/example/team-doc 这个语雀文档");
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("xuxucli.memory.dir");
            } else {
                System.setProperty("xuxucli.memory.dir", oldMemoryDir);
            }
        }
    }
