...
class RendererFactoryTest {
    ...
    @BeforeEach
    void saveProp() {
        savedProp = System.getProperty("xuxucli.renderer");
    }
    ...
    void restoreProp() {
        if (savedProp == null) {
            ...
            System.setProperty("xuxucli.renderer", savedProp);
        }
    }
    ...
    void propertyValuePlainResolves() {
        System.setProperty("xuxucli.renderer", "plain");
    ...
    void unknownValueFallsBackToInline() {
        System.setProperty("xuxucli.renderer", "weird");
        assertEquals(RendererFactory.Mode.INLINE, RendererFactory.resolveMode());
    }

    @Test
    void tuiAliasResolvesToLanterna() {
        System.setProperty("xuxucli.renderer", "tui");
        assertEquals(RendererFactory.Mode.LANTERNA, RendererFactory.resolveMode());
    }
