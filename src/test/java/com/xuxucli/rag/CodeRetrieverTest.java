...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/xuxucli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("xuxucli.rag.dir", "/tmp/xuxucli-test-rag-retriever");
