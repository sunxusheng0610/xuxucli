...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        XuxuCliConfig config = new XuxuCliConfig();
        config.getProviders().put("glm",
                new XuxuCliConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new XuxuCliConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new XuxuCliConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        XuxuCliConfig config = new XuxuCliConfig();
        config.getProviders().put("unknown", new XuxuCliConfig.ProviderConfig("test-key", null, "unknown-model"));
