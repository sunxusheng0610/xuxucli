...
新增包：`src/main/java/com/xuxucli/snapshot/`
...
```text
~/.xuxucli/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dxuxucli.snapshot.enabled=false
-Dxuxucli.snapshot.max=50
-Dxuxucli.snapshot.excludes=...
```
