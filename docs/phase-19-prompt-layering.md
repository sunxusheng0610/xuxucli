...
```text
src/main/java/com/xuxucli/prompt/
...
2. 用户级覆盖：`~/.xuxucli/prompts/...`
3. 项目级覆盖：`.xuxucli/prompts/...`

例如：

```text
~/.xuxucli/prompts/base.md
~/.xuxucli/prompts/modes/agent.md
.xuxucli/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.xuxucli/prompts/...`
- [x] 支持项目级覆盖 `.xuxucli/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
